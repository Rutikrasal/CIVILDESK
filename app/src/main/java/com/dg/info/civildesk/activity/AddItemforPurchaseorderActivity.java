...
public class AddItemforPurchaseorderActivity extends BaseActivity implements TaxlistAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_itemfor_purchaseorder);
        ...
        linearLayoutdelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new androidx.appcompat.app.AlertDialog.Builder(AddItemforPurchaseorderActivity.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Toast.makeText(AddItemforPurchaseorderActivity.this, "Item Deleted...", Toast.LENGTH_LONG).show();
                                startActivity(new Intent(AddItemforPurchaseorderActivity.this,AddPurchaseorderActivity.class).putExtra("frag","2"));
        ...
        linearLayoutupdatebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AddItemforPurchaseorderActivity.this, "Item Updated...", Toast.LENGTH_LONG).show();
                startActivity(new Intent(AddItemforPurchaseorderActivity.this,AddPurchaseorderActivity.class).putExtra("frag","2"));
        ...
        linearLayoutsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AddItemforPurchaseorderActivity.this, "Item Added...", Toast.LENGTH_LONG).show();
                startActivity(new Intent(AddItemforPurchaseorderActivity.this,AddPurchaseorderActivity.class).putExtra("frag","2"));
        ...
        linearLayoutsaveandnew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(AddItemforPurchaseorderActivity.this, AddItemforPurchaseorderActivity.class);
                ...
                i.putExtras(bundle);
                startActivity(i);
                AddItemforPurchaseorderActivity.this.finish();
...
*/
    ...
    private void getitem() {
        ...
        call.enqueue(new Callback<ItemResponse>() {
            ...
            public void onFailure(Call<ItemResponse> call, Throwable t) {
                ...
                Toast.makeText(AddItemforPurchaseorderActivity.this, "Invalid Data..", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void showDialog() {
        ...
        recyclerViewtax.setLayoutManager(new LinearLayoutManager(AddItemforPurchaseorderActivity.this));
