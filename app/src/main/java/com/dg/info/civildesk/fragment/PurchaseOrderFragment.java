...
import com.dg.info.civildesk.activity.AddPurchaseorderActivity;
...
public class PurchaseOrderFragment extends BaseFragment {
    ...
    private void getpurchaseorderdata() {
        ...
        Call<ShowPurchaseOrderResponse> call = RetrofitClient.getRetrofitClient().showpurchaseorder(userid);
        call.enqueue(new Callback<ShowPurchaseOrderResponse>() {
            @Override
            public void onResponse(Call<ShowPurchaseOrderResponse> call, Response<ShowPurchaseOrderResponse> response) {
                ...
                if (response.body() != null ) {
                    if (response.body().getResponseCode().matches("0")) {
                        ...
                        if(response.body().getData().size() != 0) {
                            ...
                            adapter=new PurchaseorderAdapter(context,response.body().getData());
...
*/
            ...
            @Override
            public void onFailure(Call<ShowPurchaseOrderResponse> call, Throwable t) {
                progressDialog.dismiss();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_add:
                Intent lr=new Intent(context, AddPurchaseorderActivity.class);
                lr.putExtra("frag","1");
