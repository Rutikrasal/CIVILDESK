...
public class AddItemtoReturnActivity extends BaseActivity implements TaxlistAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_itemto_return);
        ...
        linearLayoutdelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new androidx.appcompat.app.AlertDialog.Builder(AddItemtoReturnActivity.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Toast.makeText(AddItemtoReturnActivity.this, "Item Deleted...", Toast.LENGTH_LONG).show();
                                startActivity(new Intent(AddItemtoReturnActivity.this,AddpurchasereportActivity.class).putExtra("frag","2"));
        ...
        linearLayoutupdatebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AddItemtoReturnActivity.this, "Item Updated...", Toast.LENGTH_LONG).show();
                startActivity(new Intent(AddItemtoReturnActivity.this,AddpurchasereportActivity.class).putExtra("frag","2"));
        ...
        linearLayoutsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AddItemtoReturnActivity.this, "Item Added...", Toast.LENGTH_LONG).show();
                startActivity(new Intent(AddItemtoReturnActivity.this,AddpurchasereportActivity.class).putExtra("frag","2"));
        ...
        linearLayoutsaveandnew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(AddItemtoReturnActivity.this, AddItemtoReturnActivity.class);
                ...
                i.putExtras(bundle);
                startActivity(i);
                AddItemtoReturnActivity.this.finish();
...
*/
    ...
    private void getitem() {
        ...
        call.enqueue(new Callback<ItemResponse>() {
            ...
            public void onFailure(Call<ItemResponse> call, Throwable t) {
                ...
                Toast.makeText(AddItemtoReturnActivity.this, "Invalid Data..", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void showDialog() {
        ...
        recyclerViewtax.setLayoutManager(new LinearLayoutManager(AddItemtoReturnActivity.this));
