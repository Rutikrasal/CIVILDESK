...
import com.dg.info.civildesk.activity.AddItemforPurchaseorderActivity;
...
public class ItemAddedpurchaseorderAdapter extends RecyclerView.Adapter<ItemAddedpurchaseorderAdapter.ItemViewHolder>{
    private Context context;
    private ArrayList<ItemAdd> rowItems;
    double qty,rate,subtotal;

    public ItemAddedpurchaseorderAdapter(AddPurchaseorderActivity context, ArrayList<ItemAdd> rowItems) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ItemAddedpurchaseorderAdapter.ItemViewHolder(view);
    }
...
/*        holder.tvtotaldiscamount.setText(item.getItemDiscount().toString());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, AddItemforPurchaseorderActivity.class)
