...
public class AddVendorActivity extends BaseActivity {
    ...
    Context context;
    EditText etvendorname,etgstnum,etmobilenumber,etaddress,etpannum;
    String selectedstate,vendorname,gst,mobilenum,address,pan,statecode;
    Button btnsubmit;
    Spinner spnstate;
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(pan))
                {
                    ...
                    etpannum.setError("Enter PAN Number");
                    return;
                }
    ...
    private void addvendor() {
        ...
        Call<AddVendorResponse> call = RetrofitClient.getRetrofitClient().addvendor(vendorname,gst,address,mobilenum,pan,statecode,selectedstate);
        call.enqueue(new Callback<AddVendorResponse>() {
            ...
            public void onFailure(Call<AddVendorResponse> call, Throwable t) {
                ...
                Toast.makeText(AddVendorActivity.this, "Invalid Data..", Toast.LENGTH_SHORT).show();
            }
        });
    }
}