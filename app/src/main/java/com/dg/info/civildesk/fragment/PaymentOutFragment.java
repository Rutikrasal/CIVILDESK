...
import com.dg.info.civildesk.activity.AddPaymentoutActivity;
import com.dg.info.civildesk.activity.AddpurchasereportActivity;
import com.dg.info.civildesk.adapter.PaymentoutAdapter;
 ...
 * Use the {@link PaymentOutFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PaymentOutFragment extends BaseFragment {
    ...
    PaymentoutAdapter adapter;
    ArrayList<String> total=new ArrayList<>();
    public PaymentOutFragment() {
        // Required empty public constructor
    }

    public static PaymentOutFragment newInstance() {
        PaymentOutFragment fragment = new PaymentOutFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_payment_out, container, false);
    ...
    private void getpaymentoutdata() {
        progressDialog.show();
        progressDialog.setMessage("Please Wait!!..");
        userid = localData.getSignIn().getUserId();
        Log.d(TAG, "getpurchasebilldata: userid"+userid);
        Call<ShowPaymentOutResponse> call = RetrofitClient.getRetrofitClient().showpaymentout(userid);
        call.enqueue(new Callback<ShowPaymentOutResponse>() {
            @Override
            public void onResponse(Call<ShowPaymentOutResponse> call, Response<ShowPaymentOutResponse> response) {
                ...
                if (response.body() != null ) {
                    if (response.body().getResponseCode().matches("0")) {
                        ...
                        if(response.body().getData().size() != 0) {
                            ...
                            adapter=new PaymentoutAdapter(context,response.body().getData());
...
*/
            ...
            @Override
            public void onFailure(Call<ShowPaymentOutResponse> call, Throwable t) {
                progressDialog.dismiss();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_add:
                Intent lr=new Intent(context, AddPaymentoutActivity.class);
                lr.putExtra("frag","1");
