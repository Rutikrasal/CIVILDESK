...
import com.dg.info.civildesk.activity.AddItemtoReturnActivity;
...
public class ReturnItemAddedAdapter extends RecyclerView.Adapter<ReturnItemAddedAdapter.ItemViewHolder>{
    private Context context;
    private ArrayList<ItemAdd> rowItems;
    double qty,rate,subtotal;

    public ReturnItemAddedAdapter(AddpurchasereportActivity context, ArrayList<ItemAdd> rowItems) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ReturnItemAddedAdapter.ItemViewHolder(view);
    }
...
/*        holder.tvtotaldiscamount.setText(item.getItemDiscount().toString());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, AddItemtoReturnActivity.class)
